...
// import './Template4.css' // Import the CSS file for Template1 styles;
...
const Template4 = ({ data }) => {
    return (
        <div className="template-4 border rounded mx-auto my-4 px-sm-4 py-3 w-800">
            {/* Header section */}
            <div className="row mb-4">
                <div className="col-md-6 mb-3 mb-md-0">
                    {data.companyLogo && (
                    ...
                    <h2 className="mb-1 company-title-4">{data.companyName}</h2>
                    <p className="mb-1">{data.companyAddress}</p>
                    <p className="mb-0">Phone: {data.companyPhone}</p>
                </div>

                <div className="col-md-6 text-start text-md-end">
                    <h1 className="mb-2 invoice-title-4">Invoice</h1>
                    <div className="d-flex flex-column flex-md-row justify-content-md-end gap-2 gap-md-4">
                        <div className="w-100 w-md-50 mb-3 mb-md-0">
                            <p className="mb-1">
                                <strong>Invoice No:</strong> {data.invoiceNumber}
            ...
            <hr className="my-3 purple-border-4" />

            {/* Billing section */}
            <div className="row g-3 mb-4">
                {data.shippingName && data.shippingPhone && data.shippingAddress && (
                    <div className="col-md-6">
                        <div className="p-3 rounded h-100 billing-box-4">
                            <h3 className="mb-2 billing-title-4">Shipped To</h3>
                            <p className="mb-1">
                                <strong>{data.shippingName}</strong>
                            </p>
                            <p className="mb-1">{data.shippingAddress}</p>
                ...
                <div className="col-md-6">
                    <div className="p-3 rounded h-100 billing-box-4">
                        <h3 className="mb-2 billing-title-4">Billed To</h3>
                        <p className="mb-1">
                            <strong>{data.billingName}</strong>
                        </p>
                        <p className="mb-1">{data.billingAddress}</p>
            ...
            <hr className="my-3 purple-border-4" /> {/* Changed from orange-border4 */}
            ...
            <div className="mb-4">
                <div className="table-responsive">
                    <table className="table table-bordered">
                        <thead>
                            <tr>
                                <th className="p-2 table-header-4">Item description</th>
                                <th className="p-2 text-center table-header-4">Qty.</th>
                                <th className="p-2 text-end table-header-4">Rate</th>
                                <th className="p-2 text-end table-header-4">Amount</th>
                            </tr>
                        </thead>
                        <tbody>
                            {data.items.map((item, index) => (
            ...
            <div className="mb-4">
                <div className="d-flex justify-content-end">
                    <div className="p-3 w-100 totals-box-4" style={{ maxWidth: "300px" }}>
                        <div className="d-flex justify-content-between mb-2">
                            <span>Sub Total: </span>
                            <span>{data.subtotal.toFixed(2)}</span>
                        </div>
                        ...
                        <div className="d-flex justify-content-between fw-bold total-highlight-4">
                            <span>Total:</span>
                            <span>LKR{data.total.toFixed(2)}</span>
                        </div>
                    </div>
            ...
            {(data.accountName || data.accountNumber || data.accountBranch) && (
                <div className="mt-4">
                    <h3 className="mb-2 billing-title-4">Bank Account Details</h3>
            ...
            {data.notes && (
                <div className="mt-4">
                    <h3 className="mb-2 billing-title-4">Notes</h3>
                    <p className="mb-0">{data.notes}</p>
                </div>
            )}
        </div>
